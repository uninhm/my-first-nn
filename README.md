...
It didn't work first try. I had to add a minus sign that I had missed, and some array inizializations, but most of the logic, much to my surprise, was right.
